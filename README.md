...
```
game2unit [launcher] ...[app2unit argument] -- <game program> ...[game argument]
```

As a wrapper, all arguments given to `game2unit` will be passed down to `app2unit`.

`game2unit` will try to detect the launcher environment of your game.
It will then generate some properties for the unit and give them to `app2unit`.
